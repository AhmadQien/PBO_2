...
mhs_pekerja = MahasiswaPekerja("Wahyu", "190001", "Programmer")
mhs_pekerja.belajar() # output: Wahyu sedang belajar
mhs_pekerja.bekerja() # output: Wahyu sedang bekerja
mhs_pekerja.bersosialisasi() # output: Wahyu sedang bersosialisasi